...
decays_per_epoch= 1
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = mnist.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
...
validation_loss = sess.run(accuracy, feed_dict{x: cifar.test.images, y_true: cifar.test.labels}) 
tf.summary.histogram('Validation loss', validation_loss)
